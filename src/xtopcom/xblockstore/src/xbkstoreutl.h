...
namespace top
{
    namespace store
    {
        ...
        {
        public:
            xblockevent_t(enum_blockstore_event type,base::xvbindex_t* index,base::xvactplugin_t* plugin,const base::xblockmeta_t& meta);
        ...
        public:
            ...
            inline base::xvactplugin_t*         get_plugin()const {return _target_plugin;}
        ...
        protected:
            ...
            base::xvactplugin_t*    _target_plugin;
